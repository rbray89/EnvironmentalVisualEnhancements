...
void main ()
{
  ...
  tmpvar_41 = mix (tmpvar_39, vec3(0.0, 0.0, 1.0), vec3(detailLevel_6));
  tmpvar_3 = tmpvar_41;
  mediump vec3 lightDir_42;
  lightDir_42 = xlv_TEXCOORD3;
  mediump vec4 c_43;
  mediump float tmpvar_44;
  tmpvar_44 = clamp (dot (tmpvar_3, lightDir_42), 0.0, 1.0);
  highp vec3 tmpvar_45;
  tmpvar_45 = clamp ((_MinLight + (_LightColor0.xyz * (tmpvar_44 * 2.0))), 0.0, 1.0);
  lowp vec3 tmpvar_46;
...
void main ()
{
  ...
  lowp vec3 normal_40;
  normal_40.xy = ((packednormal_39.wy * 2.0) - 1.0);
  normal_40.z = sqrt((1.0 - clamp (dot (normal_40.xy, normal_40.xy), 0.0, 1.0)));
  mediump vec3 tmpvar_41;
  tmpvar_41 = mix (normal_40, vec3(0.0, 0.0, 1.0), vec3(detailLevel_6));
  tmpvar_3 = tmpvar_41;
  mediump vec3 lightDir_42;
  lightDir_42 = xlv_TEXCOORD3;
  mediump vec4 c_43;
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_41;
  lowp float tmpvar_42;
  tmpvar_42 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5).x;
...
void main ()
{
  ...
  tmpvar_43 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD5.xyz);
  highp float tmpvar_44;
  tmpvar_44 = (_LightShadowData.x + (tmpvar_43 * (1.0 - _LightShadowData.x)));
  shadow_42 = tmpvar_44;
  mediump vec3 lightDir_45;
  lightDir_45 = xlv_TEXCOORD3;
  mediump float atten_46;
  atten_46 = shadow_42;
  mediump vec4 c_47;
  mediump float tmpvar_48;
  tmpvar_48 = clamp (dot (tmpvar_3, lightDir_45), 0.0, 1.0);
  highp vec3 tmpvar_49;
  tmpvar_49 = clamp ((_MinLight + (_LightColor0.xyz * ((tmpvar_48 * atten_46) * 2.0))), 0.0, 1.0);
  lowp vec3 tmpvar_50;
  tmpvar_50 = (tmpvar_2 * tmpvar_49);
  c_47.xyz = tmpvar_50;
  c_47.w = tmpvar_4;
  c_1 = c_47;
  c_1.xyz = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD4));
...
Program "fp" {
// Fragment combos: 2
//   opengl - ALU: 59 to 61, TEX: 7 to 8
//   d3d9 - ALU: 55 to 56, TEX: 7 to 8
...
eaaaaaaamfabaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaafkaaaaadaagabaaa
...
aaaaaaaaaacaaaahicaabaaaaaaaaaaaakbabaaaacaaaaaaakbabaaaacaaaaaa
dcaaaaajhcaabaaaaaaaaaaapgapbaaaaaaaaaaaegacbaaaabaaaaaaegacbaaa
aaaaaaaabacaaaahbcaabaaaaaaaaaaaegacbaaaaaaaaaaaegbcbaaaaeaaaaaa
...
aaaaaaaaahaaaaaadcaaaaalpcaabaaaabaaaaaaggbcbaaaadaaaaaakgikcaaa
...
dcaabaaaadaaaaaaegbabaaaadaaaaaakgikcaaaaaaaaaaaagaaaaaaegiacaaa
...
adaaaaaaegaobaaaacaaaaaaegaobaaaadaaaaaaaaaaaaaipcaabaaaabaaaaaa
egaobaaaabaaaaaaegaobaiaebaaaaaaacaaaaaadcaaaaakpcaabaaaabaaaaaa
fgbfbaiaibaaaaaaadaaaaaaegaobaaaabaaaaaaegaobaaaacaaaaaaaaaaaaal
...
hcaabaaaaaaaaaaaegiccaaaaaaaaaaaabaaaaaaagaabaaaaaaaaaaafgifcaaa
aaaaaaaaalaaaaaadcaaaaalpcaabaaaabaaaaaaggbcbaaaadaaaaaakgikcaaa
...
dcaabaaaadaaaaaaegbabaaaadaaaaaakgikcaaaaaaaaaaaakaaaaaaegiacaaa

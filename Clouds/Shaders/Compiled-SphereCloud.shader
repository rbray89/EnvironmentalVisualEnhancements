...
void main ()
{
  ...
  vec4 c_25;
  c_25.xyz = (tmpvar_20 * clamp (((_MinLight + _LightColor0.xyz) * clamp ((_LightColor0.w * (((clamp (dot (mix (normal_24, vec3(0.0, 0.0, 1.0), vec3(tmpvar_19)), xlv_TEXCOORD5), 0.0, 1.0) - 0.01) / 0.99) * 4.0)), 0.0, 1.0)), 0.0, 1.0));
...
void main ()
{
  ...
  mediump vec4 c_59;
  highp float lightIntensity_60;
  mediump float tmpvar_61;
  tmpvar_61 = clamp ((_LightColor0.w * (((clamp (dot (tmpvar_4, lightDir_58), 0.0, 1.0) - 0.01) / 0.99) * 4.0)), 0.0, 1.0);
  lightIntensity_60 = tmpvar_61;
  highp vec3 tmpvar_62;
  tmpvar_62 = clamp (((_MinLight + _LightColor0.xyz) * lightIntensity_60), 0.0, 1.0);
  lowp vec3 tmpvar_63;
...
mediump vec4 LightingSimpleLambert( in SurfaceOutput s, in mediump vec3 lightDir, in mediump float atten ) {
    ...
    highp float lightIntensity = xll_saturate_f((_LightColor0.w * ((diff * atten) * 4.0)));
    mediump vec4 c;
    c.xyz = (s.Albedo * xll_saturate_vf3(((_MinLight + _LightColor0.xyz) * lightIntensity)));
    #line 413
    c.w = s.Alpha;
    return c;
}
...
void main ()
{
  ...
  normal_24.z = sqrt((1.0 - clamp (dot (normal_24.xy, normal_24.xy), 0.0, 1.0)));
  vec4 c_25;
  c_25.xyz = (tmpvar_20 * clamp (((_MinLight + _LightColor0.xyz) * clamp ((_LightColor0.w * ((((clamp (dot (mix (normal_24, vec3(0.0, 0.0, 1.0), vec3(tmpvar_19)), xlv_TEXCOORD5), 0.0, 1.0) - 0.01) / 0.99) * texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7).x) * 4.0)), 0.0, 1.0)), 0.0, 1.0));
  c_25.w = mix (0.0, min (tmpvar_16.w, mix (tmpvar_18.w, 1.0, tmpvar_19)), mix (clamp (((_FadeScale * sqrt(dot (p_21, p_21))) - _FadeDist), 0.0, 1.0), clamp (pow ((_FalloffScale * clamp (abs(normalize(xlv_TEXCOORD0).z), 0.0, 1.0)), _FalloffPow), 0.0, 1.0), clamp ((sqrt(dot (p_22, p_22)) - (1.2 * sqrt(dot (p_23, p_23)))), 0.0, 1.0)));
  c_1.w = c_25.w;
  c_1.xyz = (c_25.xyz + (tmpvar_20 * xlv_TEXCOORD6));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  atten_65 = tmpvar_58;
  mediump vec4 c_66;
  highp float lightIntensity_67;
  mediump float tmpvar_68;
  tmpvar_68 = clamp ((_LightColor0.w * ((((clamp (dot (tmpvar_4, lightDir_64), 0.0, 1.0) - 0.01) / 0.99) * atten_65) * 4.0)), 0.0, 1.0);
  lightIntensity_67 = tmpvar_68;
  highp vec3 tmpvar_69;
  tmpvar_69 = clamp (((_MinLight + _LightColor0.xyz) * lightIntensity_67), 0.0, 1.0);
  lowp vec3 tmpvar_70;
  tmpvar_70 = (tmpvar_3 * tmpvar_69);
  c_66.xyz = tmpvar_70;
  c_66.w = tmpvar_5;
  c_1 = c_66;
  c_1.xyz = (c_1.xyz + (tmpvar_3 * xlv_TEXCOORD6));
...
void main ()
{
  ...
  atten_60 = tmpvar_58;
  mediump vec4 c_61;
  highp float lightIntensity_62;
  mediump float tmpvar_63;
  tmpvar_63 = clamp ((_LightColor0.w * ((((clamp (dot (tmpvar_4, lightDir_59), 0.0, 1.0) - 0.01) / 0.99) * atten_60) * 4.0)), 0.0, 1.0);
  lightIntensity_62 = tmpvar_63;
  highp vec3 tmpvar_64;
  tmpvar_64 = clamp (((_MinLight + _LightColor0.xyz) * lightIntensity_62), 0.0, 1.0);
  lowp vec3 tmpvar_65;
...
void main ()
{
  ...
  atten_62 = shadow_58;
  mediump vec4 c_63;
  highp float lightIntensity_64;
  mediump float tmpvar_65;
  tmpvar_65 = clamp ((_LightColor0.w * ((((clamp (dot (tmpvar_4, lightDir_61), 0.0, 1.0) - 0.01) / 0.99) * atten_62) * 4.0)), 0.0, 1.0);
  lightIntensity_64 = tmpvar_65;
  highp vec3 tmpvar_66;
  tmpvar_66 = clamp (((_MinLight + _LightColor0.xyz) * lightIntensity_64), 0.0, 1.0);
  lowp vec3 tmpvar_67;
...
Program "fp" {
// Fragment combos: 2
//   d3d9 - ALU: 136 to 137, TEX: 9 to 10
//   d3d11 - ALU: 101 to 104, TEX: 6 to 7, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
"!!GLSL"
}
...
def c18, -0.01000214, 4.03944778, 1.20000005, 0
...
mul_sat r3.x, r1.w, c14.w
mad_pp r0.xyz, r3.x, r1, r0
mul r1.zw, v1.xyzy, c9.x
mul r1.xy, v1.zxzw, c9.x
add r2.xy, r1.zwzw, c4
texld r3.yw, r4, s2
texld r4.yw, r2, s2
...
mul r3.y, r1.z, r1.w
mul r2.x, r3.y, r3.y
mad_pp r1.xy, r1.yxzw, c17.z, c17.w
mul_pp r1.zw, r1.xyxy, r1.xyxy
add_pp_sat r1.w, r1.z, r1
mad r2.y, r2.x, c15, c15.z
mad r1.z, r2.y, r2.x, c15.w
add_pp r1.w, -r1, c13.y
mad r1.z, r1, r2.x, c16.x
rsq_pp r2.y, r1.w
mad r1.w, r1.z, r2.x, c16.y
mad r1.w, r1, r2.x, c16.z
rcp_pp r1.z, r2.y
add_pp r2.xyw, -r1.xyzz, c13.xxzy
mad_pp r1.xyz, r3.x, r2.xyww, r1
mul r1.w, r1, r3.y
dp3_pp_sat r1.y, r1, v5
add_pp r1.y, r1, c18.x
mul_pp r1.y, r1, c1.w
mul_pp_sat r3.y, r1, c18
add r1.y, -r3.z, c13
rsq r1.y, r1.y
add r2.x, r3.z, -r2.z
add r2.y, -r1.w, c16.w
cmp r1.w, -r2.x, r1, r2.y
add r1.x, -r1.w, c13.z
cmp r1.x, v1, r1.w, r1
abs r1.w, -v1.y
cmp r1.x, v1.z, r1, -r1
mad r2.x, r1, c17, c17.y
mad r1.x, r3.z, c14, c14.y
mad r1.x, r3.z, r1, c13.w
mad r1.x, r3.z, r1, c14.z
add r2.z, -r1.w, c13.y
mad r2.y, r1.w, c14.x, c14
mad r2.y, r2, r1.w, c13.w
rcp r1.y, r1.y
mul r1.y, r1.x, r1
cmp r1.x, v1.z, c13, c13.y
mul r1.z, r1.x, r1.y
mad r1.z, -r1, c14.w, r1.y
rsq r2.z, r2.z
dsy r3.zw, v1.xyxy
mad r1.w, r2.y, r1, c14.z
rcp r2.z, r2.z
mul r2.y, r1.w, r2.z
cmp r1.w, -v1.y, c13.x, c13.y
mul r2.z, r1.w, r2.y
mad r1.y, -r2.z, c14.w, r2
mad r1.z, r1.x, c13, r1
mad r1.x, r1.w, c13.z, r1.y
mul r1.y, r1.z, c15.x
dsx r1.w, r1.y
dsx r2.zw, v1.xyxy
mul r3.zw, r3, r3
...
add r2.xyz, c1, r2.z
mul_pp r0.xyz, r1, r0
mul_sat r2.xyz, r2, r3.y
mul r1.xyz, r0, r2
mad_pp oC0.xyz, r0, v6, r1
add_pp r2.x, -r0.w, c13.y
mad_pp r0.y, r3.x, r2.x, r0.w
dp3 r0.x, v0, v0
rsq r0.x, r0.x
mul r0.x, r0, v0.z
add r1.xyz, -v2, c0
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedbebnokdhjhepjljcffbmkoaoaiaijbjhabaaaaaafmbaaaaaadaaaaaa
...
gbhcghgfheaaklklfdeieefcamapaaaaeaaaaaaamdadaaaafjaaaaaeegiocaaa
...

iccabaaaaaaaaaaadkaabaaaaaaaaaaaakaabaaaaaaaaaaadoaaaaab"
}
...
dcl_texcoord6 v6.xyz
dcl_texcoord7 v7
mul r3.zw, v1.xyzy, c9.x
add r4.xy, r3.zwzw, c4
mul r0.xy, v1.zyzw, c7.x
add r1.xy, r0, c3
mul r0.zw, v1.xyxy, c7.x
add r0.xy, r0.zwzw, c3
...
texld r3.yw, r3, s2
texld r4.yw, r4, s2
add_pp r3.xz, r4.yyww, -r3.yyww
mad_pp r3.xy, r2.z, r3.xzzw, r3.ywzw
texld r0, r0, s1
texld r1, r1, s1
add_pp r1, r1, -r0
mad_pp r0, r2.z, r1, r0
...
add_pp r2.y, -r1.z, c13
mul r2.x, r2.w, r2.w
mad r1.z, r2.x, c15.y, c15
rsq_pp r3.x, r2.y
mad r2.y, r1.z, r2.x, c15.w
rcp_pp r1.z, r3.x
mad r2.y, r2, r2.x, c16.x
mad r2.y, r2, r2.x, c16
add_pp r4.xyz, -r1, c13.xxyw
mad_pp r1.xyz, r3.z, r4, r1
dsy r3.xy, v1
dp3_pp_sat r1.x, r1, v5
mad r2.x, r2.y, r2, c16.z
mul r1.y, r2.x, r2.w
add_pp r2.x, r1, c18
add r1.x, r1.w, -r2.z
add r1.z, -r1.y, c16.w
cmp r1.y, -r1.x, r1, r1.z
texldp r1.x, v7, s3
mul_pp r2.x, r2, r1
add r1.z, -r1.y, c13
cmp r1.x, v1, r1.y, r1.z
mul_pp r1.y, r2.x, c1.w
cmp r1.x, v1.z, r1, -r1
mad r2.x, r1, c17, c17.y
mul_pp_sat r3.w, r1.y, c18.y
add r1.y, -r1.w, c13
mad r1.x, r1.w, c14, c14.y
mad r1.x, r1.w, r1, c13.w
mad r1.x, r1.w, r1, c14.z
abs r1.w, -v1.y
add r2.z, -r1.w, c13.y
mad r2.y, r1.w, c14.x, c14
mad r2.y, r2, r1.w, c13.w
...
add r2.xyz, c1, r2.z
mul_pp r0.xyz, r1, r0
mul_sat r2.xyz, r2, r3.w
mul r1.xyz, r0, r2
mad_pp oC0.xyz, r0, v6, r1
add_pp r2.x, -r0.w, c13.y
mad_pp r0.y, r3.z, r2.x, r0.w
dp3 r0.x, v0, v0
rsq r0.x, r0.x
mul r0.x, r0, v0.z
add r1.xyz, -v2, c0
...
// 114 instructions, 5 temp regs, 0 temp arrays:
// ALU 100 float, 0 int, 4 uint
// TEX 7 (0 load, 0 comp, 0 bias, 1 grad)
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedfockbfjaggdidjlmbdifjingdmdpecgiabaaaaaabebbaaaaadaaaaaa
...
fdeieefckmapaaaaeaaaaaaaoladaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaa
...
gfaaaaadpccabaaaaaaaaaaagiaaaaacafaaaaaadcaaaaalpcaabaaaaaaaaaaa
ggbcbaaaacaaaaaaagiacaaaaaaaaaaaalaaaaaaegiecaaaaaaaaaaaajaaaaaa
...

...

...
agbbbaaaahaaaaaapgbpbaaaahaaaaaaefaaaaajpcaabaaaabaaaaaajgafbaaa
aaaaaaaaeghobaaaadaaaaaaaagabaaaaaaaaaaadiaaaaahbcaabaaaaaaaaaaa
...

...
nlapmjdpdbaaaaajicaabaaaabaaaaaaakbabaiaibaaaaaaacaaaaaackbabaia
...
ckaabaaaabaaaaaadbaaaaaigcaabaaaabaaaaaaagbcbaaaacaaaaaaagbcbaia
...
ddaaaaahccaabaaaabaaaaaaakbabaaaacaaaaaackbabaaaacaaaaaadbaaaaai
ccaabaaaabaaaaaabkaabaaaabaaaaaabkaabaiaebaaaaaaabaaaaaadeaaaaah
icaabaaaabaaaaaaakbabaaaacaaaaaackbabaaaacaaaaaabnaaaaaiicaabaaa
...

...

...

...

...


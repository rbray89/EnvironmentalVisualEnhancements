...
void main ()
{
  ...
  xlv_TEXCOORD3 = sqrt(dot (p_2, p_2));
  xlv_TEXCOORD4 = (tmpvar_5 * (_World2Object * _WorldSpaceLightPos0).xyz);
...
void main ()
{
  ...
  float tmpvar_19;
  tmpvar_19 = clamp (((2.0 * _DetailDist) * xlv_TEXCOORD3), 0.0, 1.0);
  vec3 tmpvar_20;
  tmpvar_20 = (tmpvar_16.xyz * mix (tmpvar_18.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_19)));
  vec3 p_21;
  p_21 = (xlv_TEXCOORD2 - _WorldSpaceCameraPos);
  float tmpvar_22;
  tmpvar_22 = clamp (((_FadeScale * sqrt(dot (p_21, p_21))) - _FadeDist), 0.0, 1.0);
  vec3 normal_23;
  normal_23.xy = ((mix (mix (texture2D (_BumpMap, ((xlv_TEXCOORD1.xy * _BumpScale) + _BumpOffset.xy)), texture2D (_BumpMap, ((xlv_TEXCOORD1.zy * _BumpScale) + _BumpOffset.xy)), tmpvar_17.xxxx), texture2D (_BumpMap, ((xlv_TEXCOORD1.zx * _BumpScale) + _BumpOffset.xy)), tmpvar_17.yyyy).wy * 2.0) - 1.0);
  normal_23.z = sqrt((1.0 - clamp (dot (normal_23.xy, normal_23.xy), 0.0, 1.0)));
  vec4 c_24;
  c_24.xyz = (tmpvar_20 * clamp ((_MinLight + (_LightColor0.xyz * (clamp (dot (mix (normal_23, vec3(0.0, 0.0, 1.0), vec3(tmpvar_19)), xlv_TEXCOORD4), 0.0, 1.0) * 2.0))), 0.0, 1.0));
  c_24.w = mix (0.0, min (tmpvar_16.w, mix (tmpvar_18.w, 1.0, tmpvar_19)), mix (tmpvar_22, clamp (pow ((_FalloffScale * clamp (abs(normalize(xlv_TEXCOORD0).z), 0.0, 1.0)), _FalloffPow), 0.0, 1.0), tmpvar_22));
  c_1.w = c_24.w;
  c_1.xyz = (c_24.xyz + (tmpvar_20 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
}
...
"vs_4_0
eefiecedfggconpifdekjhpjlbokbddcmjdbdbpaabaaaaaabaahaaaaadaaaaaa
...
ebaaaaaaaaaaaaaaaeaaaaaadgaaaaafhccabaaaadaaaaaaegacbaaaaaaaaaaa
baaaaaahbcaabaaaaaaaaaaaegacbaaaabaaaaaaegacbaaaabaaaaaaelaaaaaf
iccabaaaabaaaaaaakaabaaaaaaaaaaadiaaaaahhcaabaaaaaaaaaaajgbebaaa
...

...
egiccaaaadaaaaaaaeaaaaaadoaaaaab"
}
...
void main ()
{
  ...
  xlv_TEXCOORD3 = sqrt(dot (p_6, p_6));
...
void main ()
{
  ...
  tmpvar_48 = clamp (((2.0 * _DetailDist) * xlv_TEXCOORD3), 0.0, 1.0);
  ...
  tmpvar_52 = clamp (((_FadeScale * sqrt(dot (p_51, p_51))) - _FadeDist), 0.0, 1.0);
  highp float tmpvar_53;
  tmpvar_53 = mix (0.0, tmpvar_50, mix (tmpvar_52, clamp (pow ((_FalloffScale * clamp (abs(normalize(xlv_TEXCOORD0).z), 0.0, 1.0)), _FalloffPow), 0.0, 1.0), tmpvar_52));
  tmpvar_5 = tmpvar_53;
  lowp vec3 tmpvar_54;
  ...
  tmpvar_56 = mix (tmpvar_54, vec3(0.0, 0.0, 1.0), vec3(detailLevel_6));
  tmpvar_4 = tmpvar_56;
  tmpvar_2 = tmpvar_4;
...
void main ()
{
  ...
  mediump vec3 tmpvar_56;
  tmpvar_56 = mix (normal_55, vec3(0.0, 0.0, 1.0), vec3(detailLevel_6));
  tmpvar_4 = tmpvar_56;
  tmpvar_2 = tmpvar_4;
  mediump vec3 lightDir_57;
  lightDir_57 = xlv_TEXCOORD4;
...
void surf( in Input IN, inout SurfaceOutput o ) {
    ...
    highp float distAlpha = mix( distFade, rim, distFade);
...
void main ()
{
  ...
  normal_23.z = sqrt((1.0 - clamp (dot (normal_23.xy, normal_23.xy), 0.0, 1.0)));
  vec4 c_24;
  c_24.xyz = (tmpvar_20 * clamp ((_MinLight + (_LightColor0.xyz * ((clamp (dot (mix (normal_23, vec3(0.0, 0.0, 1.0), vec3(tmpvar_19)), xlv_TEXCOORD4), 0.0, 1.0) * texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x) * 2.0))), 0.0, 1.0));
  c_24.w = mix (0.0, min (tmpvar_16.w, mix (tmpvar_18.w, 1.0, tmpvar_19)), mix (tmpvar_22, clamp (pow ((_FalloffScale * clamp (abs(normalize(xlv_TEXCOORD0).z), 0.0, 1.0)), _FalloffPow), 0.0, 1.0), tmpvar_22));
  c_1.w = c_24.w;
  c_1.xyz = (c_24.xyz + (tmpvar_20 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedmocjbahokdjeeilenopiefdoomjgjadoabaaaaaamaahaaaaadaaaaaa
...
nmafaaaaeaaaabaahhabaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaafjaaaaae
...

...
pgbpbaaaabaaaaaadiaaaaajhcaabaaaacaaaaaafgifcaaaaaaaaaaaaeaaaaaa
...
acaaaaaabaaaaaahicaabaaaabaaaaaaegbcbaaaaaaaaaaaegbcbaaaaaaaaaaa
eeaaaaaficaabaaaabaaaaaadkaabaaaabaaaaaadiaaaaahhccabaaaacaaaaaa
pgapbaaaabaaaaaaegbcbaaaaaaaaaaadiaaaaajhcaabaaaacaaaaaafgifcaaa
...
acaaaaaaegacbaaaacaaaaaadgaaaaaghccabaaaafaaaaaaegiccaaaadaaaaaa
...
void main ()
{
  ...
  tmpvar_60 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x;
  dist_59 = tmpvar_60;
  highp float tmpvar_61;
  tmpvar_61 = _LightShadowData.x;
  lightShadowDataX_58 = tmpvar_61;
  highp float tmpvar_62;
  tmpvar_62 = max (float((dist_59 > (xlv_TEXCOORD6.z / xlv_TEXCOORD6.w))), lightShadowDataX_58);
  tmpvar_57 = tmpvar_62;
  mediump vec3 lightDir_63;
  lightDir_63 = xlv_TEXCOORD4;
...
Program "fp" {
// Fragment combos: 2
//   d3d9 - ALU: 124 to 125, TEX: 9 to 10
//   d3d11 - ALU: 92 to 93, TEX: 6 to 7, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
"!!GLSL"
}
...
dp3 r0.x, v0, v0
rsq r0.y, r0.x
add_pp r0.z, -r1.w, c13.y
mad_pp r0.x, r3.w, r0.z, r1.w
mul r0.y, r0, v0.z
abs_sat r0.z, r0.y
add r1.xyz, -v2, c0
dp3 r0.y, r1, r1
mul r0.z, r0, c6.x
pow_sat r1, r0.z, c5.x
rsq r0.y, r0.y
rcp r0.y, r0.y
mul r0.y, r0, c12.x
...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
ConstBuffer "$Globals" 128 // 128 used size, 14 vars
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedghmnbjneifeglaicechnjogdaipjlbkiabaaaaaadaapaaaaadaaaaaa
...
gcbaaaadicbabaaaabaaaaaagcbaaaadhcbabaaaacaaaaaagcbaaaadhcbabaaa
...

...
acaaaaaaegbcbaaaaeaaaaaaaaaaaaahicaabaaaabaaaaaadkaabaaaabaaaaaa
...

...
dp3 r0.x, v0, v0
rsq r0.y, r0.x
add_pp r0.z, -r2.w, c13.y
mad_pp r0.x, r1.w, r0.z, r2.w
mul r0.y, r0, v0.z
abs_sat r0.z, r0.y
add r1.xyz, -v2, c0
dp3 r0.y, r1, r1
...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_SCREEN" }
ConstBuffer "$Globals" 192 // 192 used size, 15 vars
Vector 16 [_LightColor0] 4
Vector 112 [_Color] 4
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedlmoinhdolpiagbhbboenbgbmhiehlgndabaaaaaalaapaaaaadaaaaaa
...
gbhcghgfheaaklklfdeieefcgaaoaaaaeaaaaaaajiadaaaafjaaaaaeegiocaaa
...

...
aaaaaaaaaaaaaaaaaaaaiadpdcaaaaajhcaabaaaacaaaaaaagaabaaaadaaaaaa
jgahbaaaadaaaaaaegacbaaaacaaaaaabacaaaahicaabaaaabaaaaaaegacbaaa
acaaaaaaegbcbaaaaeaaaaaaaoaaaaahdcaabaaaacaaaaaaegbabaaaagaaaaaa
...

aaaaaaaaakaabaaaaaaaaaaadoaaaaab"
}

...
void main ()
{
  ...
  float tmpvar_36;
  vec4 p_37;
  p_37 = (tmpvar_21 - tmpvar_35);
  tmpvar_36 = sqrt(dot (p_37, p_37));
  tmpvar_6.w = (tmpvar_34.w * (clamp ((_DistFade * tmpvar_36), 0.0, 1.0) * clamp ((1.0 - (_DistFadeVert * tmpvar_36)), 0.0, 1.0)));
  vec4 o_38;
  vec4 tmpvar_39;
  tmpvar_39 = (tmpvar_5 * 0.5);
  vec2 tmpvar_40;
  tmpvar_40.x = tmpvar_39.x;
  tmpvar_40.y = (tmpvar_39.y * _ProjectionParams.x);
  o_38.xy = (tmpvar_40 + tmpvar_39.w);
  o_38.zw = tmpvar_5.zw;
  tmpvar_13.xyw = o_38.xyw;
...
void main ()
{
  ...
  highp vec4 p_55;
  p_55 = (tmpvar_24 - tmpvar_53);
  tmpvar_54 = sqrt(dot (p_55, p_55));
  highp float tmpvar_56;
  tmpvar_56 = (tmpvar_9.w * (clamp ((_DistFade * tmpvar_54), 0.0, 1.0) * clamp ((1.0 - (_DistFadeVert * tmpvar_54)), 0.0, 1.0)));
  tmpvar_9.w = tmpvar_56;
  highp vec4 o_57;
  highp vec4 tmpvar_58;
  tmpvar_58 = (tmpvar_8 * 0.5);
  highp vec2 tmpvar_59;
  tmpvar_59.x = tmpvar_58.x;
  tmpvar_59.y = (tmpvar_58.y * _ProjectionParams.x);
  o_57.xy = (tmpvar_59 + tmpvar_58.w);
  o_57.zw = tmpvar_8.zw;
  tmpvar_16.xyw = o_57.xyw;

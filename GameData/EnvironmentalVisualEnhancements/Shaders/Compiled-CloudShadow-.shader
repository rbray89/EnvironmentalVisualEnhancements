// Compiled shader for all platforms, uncompressed size: 54.1KB
...
SubShader { 
 ...
 //       d3d11 : 46 math
 //        d3d9 : 52 math
 //        gles : 158 math, 2 texture, 6 branch
 //       gles3 : 158 math, 2 texture, 6 branch
 //   glesdesktop : 158 math, 2 texture, 6 branch
 //       metal : 42 math
 //      opengl : 158 math, 2 texture, 6 branch
 // Stats for Fragment shader:
 //       d3d11 : 102 math
 //        d3d9 : 122 math, 6 texture
 //       metal : 158 math, 2 texture, 6 branch
 Pass {
  ZWrite Off
  Blend DstColor Zero
Program "vp" {

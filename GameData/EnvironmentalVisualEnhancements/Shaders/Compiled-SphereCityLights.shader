...
uniform vec4 _OverlayDetailOffset;
uniform float _OverlayDetailScale;
uniform sampler2D _OverlayDetailTex;
...
void main ()
{
  ...
  vec4 tmpvar_16;
  tmpvar_16 = ((texture2DGradARB (_OverlayTex, uv_2, tmpvar_14.xy, tmpvar_14.zw) * _Color) * mix (mix (texture2D (_OverlayDetailTex, ((xlv_TEXCOORD1.xy * _OverlayDetailScale) + _OverlayDetailOffset.xy)), texture2D (_OverlayDetailTex, ((xlv_TEXCOORD1.zy * _OverlayDetailScale) + _OverlayDetailOffset.xy)), tmpvar_15.xxxx), texture2D (_OverlayDetailTex, ((xlv_TEXCOORD1.zx * _OverlayDetailScale) + _OverlayDetailOffset.xy)), tmpvar_15.yyyy));
  vec4 c_17;
...
uniform lowp vec4 _OverlayDetailOffset;
uniform highp float _OverlayDetailScale;
uniform sampler2D _OverlayDetailTex;
uniform sampler2D _OverlayTex;
...
void main ()
{
  ...
  lowp vec4 tmpvar_22;
  tmpvar_22 = (texture2DGradEXT (_OverlayTex, uv_9, tmpvar_21.xy, tmpvar_21.zw) * _Color);
  main_8 = tmpvar_22;
  lowp vec4 tmpvar_23;
  highp vec2 P_24;
  P_24 = ((xlv_TEXCOORD1.zy * _OverlayDetailScale) + _OverlayDetailOffset.xy);
  tmpvar_23 = texture2D (_OverlayDetailTex, P_24);
  detailX_7 = tmpvar_23;
  lowp vec4 tmpvar_25;
  highp vec2 P_26;
  P_26 = ((xlv_TEXCOORD1.zx * _OverlayDetailScale) + _OverlayDetailOffset.xy);
  tmpvar_25 = texture2D (_OverlayDetailTex, P_26);
  detailY_6 = tmpvar_25;
  lowp vec4 tmpvar_27;
  highp vec2 P_28;
  P_28 = ((xlv_TEXCOORD1.xy * _OverlayDetailScale) + _OverlayDetailOffset.xy);
  tmpvar_27 = texture2D (_OverlayDetailTex, P_28);
  detailZ_5 = tmpvar_27;
...
void surf( in Input IN, inout SurfaceOutput o ) {
    ...
    mediump vec4 main = (xll_tex2Dgrad( _OverlayTex, uv, uvdd.xy, uvdd.zw) * _Color);
    mediump vec4 detailX = texture( _OverlayDetailTex, ((nrm.zy * _OverlayDetailScale) + _OverlayDetailOffset.xy));
    mediump vec4 detailY = texture( _OverlayDetailTex, ((nrm.zx * _OverlayDetailScale) + _OverlayDetailOffset.xy));
    #line 449
    mediump vec4 detailZ = texture( _OverlayDetailTex, ((nrm.xy * _OverlayDetailScale) + _OverlayDetailOffset.xy));
    nrm = abs(nrm);
...
Float 2 [_OverlayDetailScale]
Vector 3 [_OverlayDetailOffset]
Float 4 [_FadeDist]
Float 5 [_FadeScale]
Float 6 [_Opacity]
Vector 7 [_Color]
SetTexture 0 [_OverlayTex] 2D
SetTexture 1 [_OverlayDetailTex] 2D
"ps_3_0
; 86 ALU, 6 TEX
dcl_2d s0
dcl_2d s1
...
Float 48 [_OverlayDetailScale]
Vector 64 [_OverlayDetailOffset] 4
Float 80 [_FadeDist]
Float 84 [_FadeScale]
Float 96 [_Opacity]
Vector 112 [_Color] 4
...
SetTexture 0 [_OverlayTex] 2D 0
SetTexture 1 [_OverlayDetailTex] 2D 1
...
Vector 16 [_LightColor0] 4
Float 112 [_OverlayDetailScale]
Vector 128 [_OverlayDetailOffset] 4
Float 144 [_FadeDist]
...
BindCB "$Globals" 0
BindCB "UnityLighting" 1
SetTexture 0 [_OverlayTex] 2D 1
SetTexture 1 [_OverlayDetailTex] 2D 2

...
PARAM c[5] = { { 1, 0.5 },
		state.matrix.mvp };
MAD result.color.xyz, vertex.normal, c[0].y, c[0].y;
...
"vs_4_0
eefiecedoldghgpcchfjccmhlkkpokagbdgfmiomabaaaaaabiacaaaaadaaaaaa
...
epfdejfeejepeoaaedepemepfcaaklklfdeieefceaabaaaaeaaaabaafaaaaaaa
...
aaaaaaaadcaaaaaphccabaaaabaaaaaaegbcbaaaabaaaaaaaceaaaaaaaaaaadp
...
void main ()
{
  lowp vec4 tmpvar_1;
  highp vec3 tmpvar_2;
  tmpvar_2 = ((normalize(_glesNormal) * 0.5) + 0.5);
...
aaaaaaaaahaaaiaeaeaaaaffabaaaaaaaaaaaaaaaaaaaaaa mov v7.w, c4.y
"
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedagakpdccjanjagmbfhhlelcibkdaoakhabaaaaaabaadaaaaaeaaaaaa
daaaaaaaceabaaaagmacaaaalmacaaaaebgpgodjomaaaaaaomaaaaaaaaacpopp
...
abaaaaacaaaaammaaaaaoeiaaeaaaaaeaaaaapoaabaacejaafaaeakaafaaiaka
ppppaaaafdeieefceaabaaaaeaaaabaafaaaaaaafjaaaaaeegiocaaaaaaaaaaa
...
aceaaaaaaaaaaadpaaaaaadpaaaaaadpaaaaaaaadgaaaaaficcabaaaabaaaaaa
